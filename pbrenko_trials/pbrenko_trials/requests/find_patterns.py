class FindPatternsCreateInvalidRequest:
    def __init__(self):
        self.errors = []
...
class FindPatternsCreateValidRequest:
...
def build_find_patterns_request(parameters=None):
    accepted_parameters = ["symbol", "interval", "start_date", "end_date"]
    invalid_req = FindPatternsCreateInvalidRequest()
    ...
    return FindPatternsCreateValidRequest(parameters=parameters)

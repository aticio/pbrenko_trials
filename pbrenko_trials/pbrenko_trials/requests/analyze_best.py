class AnalyzeBestCreateInvalidRequest:
    def __init__(self):
        self.errors = []
...
class AnalyzeBestCreateValidRequest:
...
def build_analyze_best_request(parameters=None):
    accepted_parameters = ["symbol", "interval", "start_date", "end_date"]
    invalid_req = AnalyzeBestCreateInvalidRequest()
    ...
    return AnalyzeBestCreateValidRequest(parameters=parameters)

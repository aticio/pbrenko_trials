...
def test_find_patterns_with_parameters(market_data):
    symbol = "BTCUSDT"
    # repo_type = "crypto"
    interval = "1d"
    ...
    request = build_find_patterns_request({"symbol": symbol, "interval": interval, "start_date": start_date, "end_date": end_date})

    find_patterns_use_case = FindPatternsUseCase()
    ...
    assert response.value.found_pattern == "test_pattern"


def test_find_patterns_with_invalid_request():
    repo = mock.Mock()
...
def test_find_patterns_with_invalid_resource():
    symbol = "BTCUSDT"
    # repo_type = "crypto"
    interval = "1d"
    start_date = "202101010000"
...
def test_find_patterns_with_generic_error():
    symbol = "BTCUSDT"
    # repo_type = "crypto"
    interval = "1d"
    start_date = "202101010000"
...
def test_find_patterns_with_insufficient_data():
    symbol = "BTCUSDT"
    # repo_type = "crypto"
    interval = "1d"
    start_date = "202101010000"

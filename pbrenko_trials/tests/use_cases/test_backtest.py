...
def test_backtest_with_parameters(market_data):
    symbol = "BTCUSDT"
    # repo_type = "crypto"
    percent = 6.3
    interval = "1d"
    ...
    assert response.value.percent == percent
...
def test_backtest_with_invalid_request():
    repo = mock.Mock()
    ...
    assert response.value == {
        ...
        "message": "parameters: Need 5 parameters: symbol, start_date, end_date. Got 0.",
    }


def test_backtest_with_invalid_resource():
    symbol = "BTCUSDT"
    # repo_type = "crypto"
    percent = 6.3
    interval = "1d"
...
def test_backtest_with_generic_error():
    symbol = "BTCUSDT"
    # repo_type = "crypto"
    percent = 6.3
    interval = "1d"
